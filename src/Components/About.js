...
function About() {
  ...
  return (
    <div className="flex flex-wrap justify-center items-center py-16 lg:py-24" id="Home">
      ...
      <div className="flex-1 py-4 sm:py-10 sm:pl-16 pl-5 mt-12 sm:mt-0 lg:mt-16">
      ...
      {/* Profile Image */}
      <div className="flex justify-center items-center w-[200px] h-[200px] mt-4 sm:w-[250px] sm:h-[250px] sm:ml-10 lg:mt-16">
        <img
          src={Profile}
          alt="profile"
