    ...
    <div>
      <nav className='fixed w-full z-20 top-0 bg-orange-100 bg-opacity-80'>
        <div className=' max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2'>
          ...
          <h2 className='h-8 ml-4 hover:text-orange-500 text-orange-700'><b>Portfolio</b></h2>
          
          </div>
          <div className=' flex md:order-2 bg-orange-300 rounded-lg md:hidden focus:ring-2'>
               <button onClick={toggle} className='inline-flex items-center p-2 w-10 h-10 justify-center text-sm
                text-gray-500 rounded-lg md:hidden focus:ring-2 focus:ring-gray-500'>
                <AiOutlineMenuUnfold className='text-orange-700 text-lg'>
